...
serve(async (req) => {
  ...
  try {
    ...
    const othersUrl = "https://nmomvkssloqnhogndlwg.supabase.co";
    const othersAnonKey = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Im5tb212a3NzbG9xbmhvZ25kbHdnIiwicm9sZSI6ImFub24iLCJpYXQiOjE3ODM2MTcwMjcsImV4cCI6MjA5OTE5MzAyN30.vW9yy17Em0UxtJnGfkvb10M249Ar82vlgcuLriJw0Sk";
