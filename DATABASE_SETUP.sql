...
-- ────────────────────────────────────────────────────────────────
-- 27. PRODUCTS (Variant & Size-Chart Enabled Catalog)
-- ────────────────────────────────────────────────────────────────
CREATE TABLE IF NOT EXISTS public.products (
  ...
  material         text,
  variants         jsonb DEFAULT '[]', -- Complex stocks (color -> size -> stock)
  created_at       timestamptz DEFAULT now(),
  updated_at       timestamptz DEFAULT now()
);
